...
{
    private Texture2D givenHeightMap1;
    private Texture2D givenHeightMap2;
    ...
    public void ApplyToTerrain() // applies the given settings to the terrain
    {
        Load();
    ...
    private void Load() // loads necessary parameters and settings for terrain generating from TerrainMakingManager
    {
        givenHeightMap1 = TerrainMakingManager.Instance.heightMap1;
        givenHeightMap2 = TerrainMakingManager.Instance.heightMap2;
