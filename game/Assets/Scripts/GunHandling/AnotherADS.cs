...
public class AnotherADS : MonoBehaviour
{
    [Header("Positions (local)")]
    public Vector3 gunPosition = new Vector3(0.125f, -0.19f, 0.6f);
    //public Vector3 adsPosition = new Vector3(0f, -0.19f, 0.6f);
    public float hipPosition = 0.125f;
    ...
    void Update()
    {
        ...
        gunPosition += new Vector3(0f, 0f, localOffSetZ);
